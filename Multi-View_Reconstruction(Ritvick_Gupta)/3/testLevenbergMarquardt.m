        ...
        % decreases the cost).
            ...
            if newErr < err
                ...
                if abs(newErr - err) < tolerance
                    ...
                    p = p-deltap% --- code here --- %;
                    J = getJacobianOfGaussian(x,p)% --- code here --- %;
                    residual = getResidualGaussian(x,p,y)% --- code here --- %;
                    err = norm(residual,2)% --- code here --- %;
                    A = J'*J;% --- code here --- %;
                    g = J'*residual;% --- code here --- %;
